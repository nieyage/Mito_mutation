...
celltype_file <- "/md01/nieyg/project/mito_mutation/02_mm10_pipeline/03_singlecell_SNV/gexbarcode_celltype.csv"
...
plot_mut<- plot_and_save_mutation_signature(
   mutation_data,
   output_prefix = "BMMC_27m",
   title_prefix = "BMMC_27m",width = 8, height = 8
 )
