...
python /data/R02/nieyg/pipeline/mito_mutation/01_human/counts2h5ad_v2.py -i /md01/nieyg/project/mito_mutation/05_publish_dnbc4tools/CNR1280832/mutation/test_10x/SNV_all \
-o ./All_cell_combined_counts_v2.h5ad

python /data/R02/nieyg/pipeline/mito_mutation/01_human/merge_snvs_v2.py -i /md01/nieyg/project/mito_mutation/05_publish_dnbc4tools/CNR1280832/mutation/test_10x/SNV_all -o ./All_cells_merged.snv.tsv


# 2. barcode_coverage.tsv.gz

python /data/R02/nieyg/pipeline/mito_mutation/01_human/extract_coverage.py \
-i  /md01/nieyg/project/mito_mutation/05_publish_dnbc4tools/CNR1280832/mutation/test_10x/SNV_all \
...
python3 /data/R02/nieyg/pipeline/mito_mutation/01_human/mt_mutation_stats_v2.py \
...
python3 /data/R02/nieyg/pipeline/mito_mutation/01_human/mt_mutation_stats_v3.py \
  -s ./All_cells_merged.snv.tsv \
  -a ./All_cell_combined_counts_v2.h5ad \
  -o ./final_mutation_report_v3.tsv
