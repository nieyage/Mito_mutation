...
python ../extract_coverage.py -i ./SNVcalling_allcell -o barcode_coverage.tsv.gz -p 16 -b 1000
...
# 基本用法
python ../SNV_summary_v2.py -i ./SNVcalling_allcell -o ./snv.tsv -v 
...
-d ./SNVcalling_allcell \
-o variant_sparse_matrix.tsv.gz --workers 30
